...
require 'action_web_service/xsd/xmlparser/parser'
...
loaded = false
[
  'action_web_service/xsd/xmlparser/xmlparser',
  'action_web_service/xsd/xmlparser/xmlscanner',
  'action_web_service/xsd/xmlparser/rexmlparser',
].each do |lib|
  begin
    require lib
    loaded = true
